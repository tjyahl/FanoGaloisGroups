...
path3 u=graph(l,0-pi/3,-2pi-pi/3);
path3 lift1=graph(lift,0-pi/3,-2pi-pi/3);
path3 lift2=graph(lift,-2pi-pi/3,-4pi-pi/3);
path3 proj=graph(d,.7,1.8);

dot(point(u,0),bluepen + 7);
dot(point(lift1,0),bluepen+7);
dot(point(lift2,0),bluepen+7);
